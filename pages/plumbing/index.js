...
export async function getServerSideProps() {
  ...
  try {
    ...
    const pageHeadDataFilePath = path.join(
      process.cwd(),
      "public/data/PageHeadData/Plumbing/",
      "SitePlumbing_PageHeadData_INDEX.json"
    );
...
export default function PlumbingIndex({ TOTAL_NUMBER_OF_IPS, page_head_data }) {
