/**
 *
 *  This is the Home Improvement Contact
 *
 */
...
export async function getServerSideProps() {
  ...
  try {
    ...
    const pageHeadDataFilePath = path.join(
      process.cwd(),
      "public/data/PageHeadData/HomeImprovement/",
      "SiteHomeImprovement_PageHeadData_CONTACT.json"
    );
...
export default function HomeImprovementContact({
  TOTAL_NUMBER_OF_IPS,
  page_head_data,
}) {
