...
export default function LawnCareGallery({ TOTAL_NUMBER_OF_IPS }) {
  ...
  useEffect(() => {
    ...
    const FETCH_DATA = async () => {
      try {
        const response = await fetch("/api/trackers/trackLawnCareIPs");
